...
def prepare_data(df, target_col="y"):
    """This method returns lable and independent features
    ...
    Returns:
        tuple: label and X
    """
    logging.info("Preparing data for the training")
...
def save_plot(df, model, filename="plot.png", plot_dir="plots"):
    ...
    Args:
        ...
        filename (str, optional): plot name. Defaults to "plot.png".
        plot_dir (str, optional): plot directory. Defaults to "plots".
    """
